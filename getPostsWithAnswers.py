...
import urllib2,time,re,sys,os,json
import progressbar
import argparse
...
def get_options():
	...
	parser.add_argument('-data_dir', action="store", default='/scratch/cse/btech/cs1130773/BTP/Data_from_Poojan/Danish_Data/Raw_Data/',
...
def buildJSON(options):
	...
	#				 'New York','Ohio','Virginia','Washington','Oregon']) # Austria is not done. Revisit later 
